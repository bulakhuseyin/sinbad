...
export default function TaekwondoAnalyzer() {
  ...
  const handleUpload = async () => {
    ...
    // Simülasyon amaçlı analiz sonucu
    setTimeout(() => {
      setAnalysisResult({
        totalKicks: 28,
        fatigueStartMinute: 2.5,
        mostCommonTechnique: "Bandal Chagi",
        scoreLostFrom: "Kontra sağ gövde vuruşu",
      });
      setUploading(false);
    }, 2000);
  };
